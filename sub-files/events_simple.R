...
"event_A_TK = function(traj, inputs) 
{
  traj %>% 
    ...
    set_attribute(\"aControlOrder_TK\",function(attrs) sample(c(1,0),1,prob=c(inputs$vProbabilityOrder_TK[attrs[[\'aPSA_ID\']]],1-inputs$vProbabilityOrder_TK[attrs[[\'aPSA_ID\']]]))) %>%
                   set_attribute(\"aControlRead_TK\",function(attrs) sample(c(1,0),1,prob=c(inputs$vProbabilityRead_TK[attrs[[\'aPSA_ID\']]],1-inputs$vProbabilityRead_TK[attrs[[\'aPSA_ID\']]]))) %>% 
